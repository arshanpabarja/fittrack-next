...
class CameraWorker(QThread):
    ...
    def __init__(self, models_dir, camera_indices=(0, 1, 2), auto_capture=False, parent=None):
        ...
        try:
            ...
            while not self.isInterruptionRequested():
                ...
                if frame_number % 3 == 0:
                    ...
                    latest_face = max(faces, key=lambda face: face[2] * face[3]) if faces is not None and len(faces) else None
                    if latest_face is None:
                        ...
                        self.status_changed.emit("چهره شناسایی شد؛ در حال ثبت ورود…")
                preview = frame.copy()
