...
class DashboardPage(QWidget):
    ...
    def _brand_mark(self):
        ...
        if not pixmap.isNull():
            logo.setPixmap(pixmap.scaled(390, 390, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation))
